...
Accessing the streamed frames did not work with Shared Network. Some issue with the RTC protocol used by the Neon. Using a Bridged Network should put the VM on the same network as the host and the glasses should be auto-discoverable.
